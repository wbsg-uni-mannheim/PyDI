...
_Generated at 2026-05-03T08:58:14.332913+00:00_
...
|---|---|---|---|---|
| sm | macro_f1 | 0.4529 | 0.3620 | 0.0909 |
| em | macro_f1 | 0.9554 | 0.8508 | 0.1046 |
...
| llm_openai | 0.6316 | 0.8679 | -0.2363 |

## Stage: em - per member

| member | f1 | f1_baseline | f1_delta | pool_precision | pool_precision_baseline | pool_recall | pool_recall_baseline |
|---|---|---|---|---|---|---|---|
| ditto_plm | 0.9554 | 0.8508 | 0.1046 | 0.6764 | 0.9146 | 0.3717 | 0.3945 |

## Stage: em - per pair

| pair | member | f1 | f1_baseline | f1_delta |
|---|---|---|---|---|
| musicbrainz_discogs | ditto_plm | 0.9457 | 0.7966 | 0.1491 |
...
| name_longest_string | 0.5099 | 0.5364 | -0.0265 |
| name_most_complete | 0.5099 | 0.5364 | -0.0265 |
...
| name | 0.8261 | 0.8261 | 0.0000 | 0.0870 | 0.0870 | 0.0000 |
