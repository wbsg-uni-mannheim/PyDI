 ...
 * @param <RecordType>
 */
public class FusibleParallelHashedDataSet<RecordType extends Matchable & Fusible<SchemaElementType>, SchemaElementType extends Matchable> extends
		ParallelHashedDataSet<RecordType, SchemaElementType> implements FusibleDataSet<RecordType, SchemaElementType> {
