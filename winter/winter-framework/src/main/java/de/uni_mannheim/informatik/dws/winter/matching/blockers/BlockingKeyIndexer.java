...
// CorrespondenceType>
{
	...
	public BlockingKeyIndexer(BlockingKeyGenerator<RecordType, CorrespondenceType, BlockedType> blockingFunction,
	...
	public Processable<Correspondence<BlockedType, CorrespondenceType>> runBlocking(
		...
		Processable<Triple<String, BlockedType, BlockedType>> pairs = blocks1.join(blocks2, new BlockJoinKeyGenerator())
				.map((Pair<BlockingKeyIndexer<RecordType, SchemaElementType, BlockedType, CorrespondenceType>.Block, BlockingKeyIndexer<RecordType, SchemaElementType, BlockedType, CorrespondenceType>.Block> record,
		...
		return vectors.aggregate(
				(Pair<BlockedType, BlockingKeyIndexer<RecordType, SchemaElementType, BlockedType, CorrespondenceType>.BlockingVector> record,
					...
					for (String s : record.getSecond().keySet()) {
						...
						DataIterator<BlockingKeyIndexer<RecordType, SchemaElementType, BlockedType, CorrespondenceType>.Block> resultCollector) -> {
	...
	protected Processable<Pair<String, Double>> createDocumentFrequencies(Processable<Block> blocks1,
		...
		Processable<Pair<String, Double>> df1 = blocks1
				.map((BlockingKeyIndexer<RecordType, SchemaElementType, BlockedType, CorrespondenceType>.Block record,
	...
	protected Processable<Pair<BlockedType, BlockingVector>> createTFIDFVectors(
		...
		return vectors.map((
				Pair<BlockedType, BlockingKeyIndexer<RecordType, SchemaElementType, BlockedType, CorrespondenceType>.BlockingVector> record,
				DataIterator<Pair<BlockedType, BlockingKeyIndexer<RecordType, SchemaElementType, BlockedType, CorrespondenceType>.BlockingVector>> resultCollector) -> {
	...
	protected Processable<Correspondence<BlockedType, CorrespondenceType>> createCorrespondences(
		...
		return pairsWithVectors.aggregate((
				Triple<String, Pair<BlockedType, BlockingKeyIndexer<RecordType, SchemaElementType, BlockedType, CorrespondenceType>.BlockingVector>, Pair<BlockedType, BlockingKeyIndexer<RecordType, SchemaElementType, BlockedType, CorrespondenceType>.BlockingVector>> record,
		...
		}).map((Pair<Pair<Pair<BlockedType, BlockingKeyIndexer<RecordType, SchemaElementType, BlockedType, CorrespondenceType>.BlockingVector>, Pair<BlockedType, BlockingKeyIndexer<RecordType, SchemaElementType, BlockedType, CorrespondenceType>.BlockingVector>>, Correspondence<BlockedType, CorrespondenceType>> record,
