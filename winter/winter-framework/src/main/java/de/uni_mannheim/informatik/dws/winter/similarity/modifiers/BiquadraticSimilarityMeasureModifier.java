 ...
 *
 */
public class BiquadraticSimilarityMeasureModifier<DataType> extends SimilarityMeasureModifier<DataType> {

	private static final long serialVersionUID = 1L;

	public BiquadraticSimilarityMeasureModifier() {
	}
	
	public BiquadraticSimilarityMeasureModifier(SimilarityMeasure<DataType> decoratedObject) {
