...
Total runtime: 5179.2 s

## Per-stage winners

| Stage | Winner | Metric | Val score | Test score | Runtime (s) |
|---|---|---|---|---|---|
| sm | `llm_openai` | f1 | 1.0000 | 1.0000 | 37.2 |
| norm | `rule_per_attribute_optimal` | macro_f1 | 0.8704 | 0.8704 | 1.1 |
| em_blocking | `bm25_blocker` | pair_completeness (>=0.97 floor; reduction_ratio tiebreak) | 0.9951 | 0.9951 | 4300.7 |
| em_matching | `magellan` | f1 | 0.9324 | 0.9324 | 4300.7 |
| refinement | `baseline` | f1 | 0.9532 | 0.9324 | 0.6 |
| fusion | `voting_only` | macro_accuracy | 0.7213 | 0.6511 | 825.0 |
